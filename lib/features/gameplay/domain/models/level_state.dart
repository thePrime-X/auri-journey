...
class LevelState {
  ...
  String toString() {
    return 'LevelState('
        ...
        'firstFailureHint: $firstFailureHint, '
        'repeatedFailureHint: $repeatedFailureHint'
        ')';
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is LevelState &&
        ...
        listEquals(other.optimalSolution, optimalSolution) &&
        other.reflectionPrompt == reflectionPrompt &&
        other.firstFailureHint == firstFailureHint &&
        other.repeatedFailureHint == repeatedFailureHint;
  }
  ...
  int get hashCode {
    return Object.hash(
      ...
      rewardXp,
      learningObjective,
      Object.hashAll(optimalSolution),
      reflectionPrompt,
      firstFailureHint,
      repeatedFailureHint,
    );
